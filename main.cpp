...
/**
 *Exercici 18
Fer un programa que simuli una calculadora. El programa ha de presentar un menú indicant:
Menú Calculadora:
    1) Sumar
    2) Restar
    3) Multiplicar
...
float operar(char op, float v1, float v2){
...
void ex18() {
    ...
    do {
        ...
        switch (op) {
            ...
            case 1: 
                getDosNumeros();
                cout << valors[0] << " + " << valors[1] << " = " << operar('+',valors[0],valors[1]) <<endl;
                break;
            case 2:
                getDosNumeros();
                cout << valors[0] << " - " << valors[1] << " = " << operar('-',valors[0],valors[1]) <<endl;
            ...
            case 4:
                ...
                if(valors[1]!=0){
                    ...
                    cout << "ERROR: No es pot dividir per 0." <<endl;
                }
                break;
            case 5:
                cout << "Dew" <<endl;
                break;
            default:
                cout << "Número d'operacio no vàlida." << endl;
                break;
        }
